...
namespace S2SettingsGenerator
{
    public struct GlobalIlluminationQualitySettings : ISettingsModel
    {
        ...
        public void appendLines(StringBuilder sb)
        {
            ...
            sb.AppendLine($"r.LumenScene.SurfaceCache.AtlasSize={r_LumenScene_SurfaceCache_AtlasSize}");
            sb.AppendLine($"r.Lumen.SurfaceCache.CardCaptureRefreshFraction={r_LumenScene_SurfaceCache_CardCaptureRefreshFraction}");
            ...
            sb.AppendLine($"r.Lumen.ScreenProbeGather.FullResolutionJitterWidth={r_Lumen_ScreenProbeGather_FullResolutionJitterWidth}");
            ...
            sb.AppendLine($"r.Lumen.ScreenProbeGather.RadianceCache.GridResolution={r_Lumen_ScreenProbeGather_RadianceCache_GridResolution}");
            sb.AppendLine($"r.Lumen.ScreenProbeGather.RadianceCache.ProbeResolution={r_Lumen_ScreenProbeGather_RadianceCache_ProbeResolution}");
